 ...
 *
 * ExpressCapture v2.30
 * Express Capture for the web.
 *
 * WEB-1-1 08/06/2016 02:39:31
 */
/** @namespace pca */
(function (window, undefined) {
    ...
    pca.host = "expresscapture.datatoolscloud.net.au";
...
(function () {
    ...
    pca.CountryList = function (fields, options) {
        ...
        countrylist.options.fallbackCode = countrylist.options.fallbackCode || "AUS";
...
(function () {
    ...
    pca.Address = function (fields, options) {
        ...
        address.options.brand = address.options.brand || "DataTools" || "PostcodeAnywhere";
        address.options.product = address.options.product || "ExpressCapture";
        ...
        address.options.bar.logoClass = address.options.bar.logoClass || "dtlogo" || "pcalogo";
        address.options.bar.logoTitle = address.options.bar.logoTitle || "www.datatools.com.au";
        address.options.bar.logoUrl = address.options.bar.logoUrl || "http://www.datatools.com.au/";
        ...
        address.retrieve = function (id) {
            ...
            function success(response) {
                if (response.length) {address.populate(response); if(pcaUpdateCallback){pcaUpdateCallback(response[0].PostalCode);}} else {fail(response);} //TJ: added callback
            }
